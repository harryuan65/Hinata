...
typedef struct fighter_t
{
	...
	U32	w_silver,	b_silver;		//  2,  3
	U32 w_gold,		b_gold;			//  4,  5
	U32 w_bishop,	b_bishop;		//  6,  7
	U32 w_rook,		b_rook;			//  8,  9
	U32 w_king,		b_king;			// 10, 11
	U32 w_e_pawn,	b_e_pawn;		// 12, 13
	U32	w_e_silver,	b_e_silver;		// 14, 15
...
/*	rank lower	*/
const U32 rank_lower[BOARD_SIZE] = {
